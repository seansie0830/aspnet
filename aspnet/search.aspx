...
/* 1. 快速查詢區塊樣式 */
        ...
        /* 3. GridView 標頭樣式 (確保藍色生效) */
        #<%= gvBooks.ClientID %> thead th {
            background-color: #007bff !important; /* 主藍色標頭 */
            color: white !important;
            font-weight: bold;
            border: 1px solid #007bff !important;
        }
        
        /* 4. 【關鍵修正】GridView 表格邊框與內文樣式 */
        #<%= gvBooks.ClientID %> th, 
        #<%= gvBooks.ClientID %> td {
            border: 1px solid #c9c9c9; /* 加上淺灰色邊框 */
            padding: 8px;
        }
        
        /* 5. 【視覺修正】GridView 內文隔行換色 */
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="lblResultInfo" runat="server" ForeColor="Blue" Text="" style="margin-bottom: 10px; display: block;"></asp:Label>
